...
import 'package:taxi/bookNow/numberOfPassengersBookNow.dart';
...
class _BookNowState extends State<BookNow> {
  ...
  late String finishInfoWindow = 'Choose Destination';
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      String startCoordinatesString = '($lat, $long)';
      ...
      double miny = (lat <= finishLat) ? lat : finishLat;
      double minx = (long <= finishLang) ? long : finishLang;
      double maxy = (lat <= finishLat) ? finishLat : lat;
      double maxx = (long <= finishLang) ? finishLang : long;
      ...
      await _createPolylines(lat, long, finishLat, finishLang);
                                                    ...
                                                    child: const Padding(
                                                      padding:
                                                          EdgeInsets.fromLTRB(
                                                              20, 10, 20, 10),
                                                      child: Text(
                                                          'Your Current Location (Auto Selected)',
                                                          style: TextStyle(
                                                            fontWeight:
                                                                FontWeight.w300,
                                                            color: Colors.white,
                                                    ...
                                                    ElevatedButton(
                                                      onPressed: () {
                                                        ...
                                                        showDialog(
                                                            context: context,
                                                            builder: (context) =>
                                                                NumberOfPassengersBookNow(
                                                                    numberONumberOfPassengersBookNow:
                                                                        numberOfPassengers));
                                                      },
                                                      child: Padding(
                                                        padding:
