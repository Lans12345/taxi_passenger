...
import 'package:taxi/bookAFriend/numberOfPassengersBookAFriend.dart';
...
class BookAFriend extends StatefulWidget {
  const BookAFriend({Key? key}) : super(key: key);
  @override
  State<BookAFriend> createState() => _BookAFriendState();
}

late double myLat;
late double myLong;

class _BookAFriendState extends State<BookAFriend> {
  @override
  void initState() {
    getData1();
    super.initState();
  ...
  late String startInfoWindow = "Friend's Pick Up Location";
  ...
  late String finishInfoWindow = "Friend's Destination";
