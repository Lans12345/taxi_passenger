...
class BookAFriendConfirmation extends StatefulWidget {
  const BookAFriendConfirmation({Key? key}) : super(key: key);

  @override
  State<BookAFriendConfirmation> createState() =>
      _BookAFriendConfirmationState();
}

class _BookAFriendConfirmationState extends State<BookAFriendConfirmation> {
  @override
  void initState() {
    super.initState();
    getData1();
  ...
  Future booking() async {
    ...
    final json = {
      ...
      'rating': driverRating,
      'userContactNumber': contactNumberOfFriend,
